...
<p>
<img src="images/rpm.jpg" title="RPM"  width="50%" height="50%" align="right">
...
## 特徴
rtctreeとTkinterを利用したGUIの支援ツールを開発し授業で活用した．OpenRTMでインストールするファイルだけで使用できる．設定ファイルを書き換えることによって様々な実機とシミュレータの組み合わせに利用できるように汎用化したツールである．
...
<p><img src="images/system.jpg" title="システム概要図"  width="50%" height="50%" align="right"></p> 
